...
namespace SalesWebMVC.Data
{
    ...
    {
        //registrar um dependência com o DbContext que nesse caso é o SalesWebMVCContext.cs
        ...
        //operação responsábel por popular base de dados
        public void Seed()
        {   //Any testa se tem algum regirstro na tabela
            if (_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any() )
            {
                //se existir dadas nas tabelas return - corta a execução do método
                return;
            }
